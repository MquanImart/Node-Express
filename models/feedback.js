...
class FeedBack{
    static async addCommentSql(user_id, book_id, content, star) {
        ...
        let sql = `INSERT INTO comments(book_id, user_id, content, comment_date) values(${book_id}, ${user_id}, '${content}', '${post_date}')`;
